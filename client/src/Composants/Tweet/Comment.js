...
const handleRedirect = (userid) => {
    ...
    return (
        <div className='border-bottom border-top' style={{margin: "10px", borderRadius: "10px"}}>
                ...
                <div className='header d-flex justify-content-between' style={{padding: "8px"}}>
                    <Link to={`/profil/${comment.userid}`} style={{textDecoration: "none"}} className="d-flex align-items-center" onClick={() => { handleRedirect(comment.userid) }}>
                        ...
                        <span className="text-info" style={{ marginLeft: "15px" }}>@{myComment.pseudo}</span>
                    </Link>
                ...
                <div className="body">
                    ...
                    <div className="text-warning" style={{margin: "7px 20px"}}>
